...
sendFile="/home/dmcdevelopment/Desktop/gitDMC/dmcrest/v0.1.8/dmcrestMaster/dmcrest/target/dmc-site-services-0.1.0-swagger.war"
#key for frontend machine
rest_ssh_keyC="/home/dmcdevelopment/Desktop/keys/portalAzure/v0.1.3/betav040417"
#front machine user do not chnage for aws
rest_userC=dmcAdmin
#ip of frontend machine
rest_hostC="13.84.54.29"
